const widgets = [
  { image: "./img/1.avif", name: "Haseeb" },
  { image: "./img/2.jpg", name: "Anglina" },
  { image: "./img/3.jpg", name: "Fighter" },
  { image: "./img/4.jpg", name: "Tom Cruise" },
  { image: "./img/5.jpg", name: "Dom" },
  { image: "./img/0011.jpg", name: "gigi Hadid" },
  { image: "./img/0024.jpg", name: "semi" },
  { image: "./img/0149.jpg", name: "Ronaldo" },
  { image: "./img/0235.jpg", name: "Women" },
  { image: "./img/c.jpg", name: "Sexy me" },
];
...
const animate = () => {
  ...
  svg.querySelectorAll("[data-segment]").forEach((reg) => {
    reg.setAttribute(
      "transform",
